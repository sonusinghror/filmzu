  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested account" do
        ...
        Account.any_instance.should_receive(:update_attributes).with({ "account_id" => "MyString" })
        put :update, {:id => account.to_param, :account => { "account_id" => "MyString" }}, valid_session
      end
