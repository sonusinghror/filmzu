...
describe DisputesController do
  ...
  let(:valid_attributes) { { "dispute_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved dispute as @dispute" do
        ...
        post :create, {:dispute => { "dispute_id" => "invalid value" }}, valid_session
        assigns(:dispute).should be_a_new(Dispute)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested dispute" do
        ...
        Dispute.any_instance.should_receive(:update_attributes).with({ "dispute_id" => "1" })
        put :update, {:id => dispute.to_param, :dispute => { "dispute_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the dispute as @dispute" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Dispute.any_instance.stub(:save).and_return(false)
        put :update, {:id => dispute.to_param, :dispute => { "dispute_id" => "invalid value" }}, valid_session
        assigns(:dispute).should eq(dispute)
      end
